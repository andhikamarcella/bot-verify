...
async function registerApplicationCommands() {
  ...
  try {
    console.log(`🔁 Menyinkronkan ${payload.length} slash command ke aplikasi...`);
    await rest.put(Routes.applicationCommands(process.env.DISCORD_CLIENT_ID), { body: payload });
    console.log('✅ Command global diperbarui.');
    ...
    if (process.env.GUILD_ID) {
      ...
      console.log(`✅ Command guild diperbarui untuk ${process.env.GUILD_ID}.`);
    }
  } catch (error) {
