...
module.exports = {
  data: new SlashCommandBuilder()
    .setName('voiceverify-stop')
    .setDescription('Hentikan sesi voice verification dan disconnect bot'),
  ...
  async execute(interaction) {
    ...
    await interaction.reply({ content: '✅ Sesi voice verification dihentikan dan bot disconnect.', flags: 64 });
  },
};
